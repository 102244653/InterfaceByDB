...
public class InitExcelReport {
    ...
    public static String ExcelPath="./TestExcelReport/API"+ExcelName+".xls";
    public static String[] meanu={"APIName","CaseName","RequestMethod","TestURL","RequestData","ExpectResult","ResponseData","Result",};
